...
fun HomePage(viewModel: SurveyViewModel, onNavigateToUserInfo: () -> Unit) {
    ...
    Column(
        ...
        Button(colors = ButtonDefaults.buttonColors(colorResource(R.color.yellow)),onClick = { viewModel.generateParticipantID() }) { // Generate a new ID
            Text("Get participant ID")
        }
